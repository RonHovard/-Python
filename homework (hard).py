...
if age <= 30 and (50 <= weight <= 120):
    print('{} {},возраст: {},вес: {} - Хорошее состояние!'.format(name, surname, age, weight))
elif age >= 30 and (weight <= 50 or weight >= 120):
    print('{} {},возраст: {},вес: {} - Следует заняться своим здоровьем!'.format(name,surname,age,weight))
elif age > 40 and (weight < 50 or weight > 120):
    print('{} {},возраст: {},вес: {} - Следует обратиться к врачу!'.format(name, surname, age, weight))
